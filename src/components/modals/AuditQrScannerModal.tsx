...
//                 // // ) {
//                 // //   return; // ignore repeated quick scan
//                 // // }
...
//                 if (processing || decodedText === lastProcessedCodeRef.current) {
//                   return;
//                 }
...
//                   if (!result.valid) {
//                     setErrorMessage(`Invalid location QR code. Expected: ${result.expected}\nPlease scan again.`);
//                     // testing
//                     setTimeout(() => {
//                       setProcessing(false);
//                       // Clear the last processed code after a delay to allow rescanning
//                       setTimeout(() => {
...
//                   if (!result.success) {
//                     setErrorMessage(result.message || 'Failed to update audit record.');
//                     setTimeout(() => {
//                       setProcessing(false);
//                       // Clear the last processed code after a delay to allow rescanning
//                       setTimeout(() => {
